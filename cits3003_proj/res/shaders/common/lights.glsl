...
// dir Lights
void point_light_calculation(DirectionalLightData point_light, LightCalculatioData calculation_data, float shininess, inout vec3 total_diffuse, inout vec3 total_specular, inout vec3 total_ambient) {
...
// Directional Lights
void point_light__dir_calculation(DirectionalLightData dir_light, LightCalculatioData calculation_data, float shininess, inout vec3 total_diffuse, inout vec3 total_specular, inout vec3 total_ambient) {
...
LightingResult total_light_calculation(LightCalculatioData light_calculation_data, Material material
    ...
    for (int i = 0; i < NUM_PL_DIR; i++) {
        point_light__dir_calculation(dir_light[i], light_calculation_data, material.shininess, total_diffuse, total_specular, total_ambient);
    }
    #endif
