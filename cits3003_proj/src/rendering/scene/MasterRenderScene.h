...
public:
    ...
    void set_directional_light(std::shared_ptr<DirectionalLight> directional_light); // Add support for directional lights

    bool remove_light(const std::shared_ptr<PointLight>& point_light);
    bool remove_directional_light(std::shared_ptr<DirectionalLight> directional_light); // Add support for directional lights
