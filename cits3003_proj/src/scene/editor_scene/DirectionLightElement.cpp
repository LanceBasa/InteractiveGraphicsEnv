...
std::unique_ptr<EditorScene::DirectionLightElement> EditorScene::DirectionLightElement::new_default(const SceneContext& scene_context, EditorScene::ElementRef parent) {
    auto light_element = std::make_unique<DirectionLightElement>(
        parent,
        "New Direction Light",
...
std::unique_ptr<EditorScene::DirectionLightElement> EditorScene::DirectionLightElement::from_json(const SceneContext& scene_context, EditorScene::ElementRef parent, const json& j) {
...
json EditorScene::DirectionLightElement::into_json() const {
    return {
        {"position",     position},
        {"colour",       light->colour},
        {"visible",      visible},
...
void EditorScene::DirectionLightElement::add_imgui_edit_section(MasterRenderScene& render_scene, const SceneContext& scene_context) {
...
void EditorScene::DirectionLightElement::update_instance_data() {
...
const char* EditorScene::DirectionLightElement::element_type_name() const {
